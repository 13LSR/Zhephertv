...
function HomeClient() {
  ...
  const [aiEnabled, setAiEnabled] = useState<boolean | null>(null); // null表示检查中,true显示按钮,false隐藏按钮
        ...
        <div className='mb-8 flex flex-col sm:flex-row items-center justify-center gap-4'>
          ...
          {aiEnabled === true && (
            <button
              ...
              className='flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-full font-medium transition-all transform hover:scale-105 shadow-lg hover:shadow-xl animate-fade-in'
              title='AI影视推荐'
            >
